...
const SectionPointsCard: React.FC<{
  ...
  > = {
    ...
    writing:         { icon: '📝', label: 'Tự luận',      color: 'from-violet-400 to-violet-500' } // ✅ Thêm màu sắc cho Tự luận
  };

  // ✅ Fallback an toàn phòng trường hợp type chưa được định nghĩa
  const info = typeInfo[section.questionType] || { icon: '❓', label: 'Khác', color: 'from-gray-400 to-gray-500' };
